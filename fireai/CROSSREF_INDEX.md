# FireAI — Constants Cross-Reference Map
...
**Canonical Source:** `backend/services/air_quality_service.py`
...
### `DEFAULT_AUTO_IGNITION_C`

**Canonical Source:** `backend/services/hazmat_service.py`
...
- `backend/services/hazmat_service.py`:344
- `backend/services/hazmat_service.py`:346
- `backend/services/hazmat_service.py`:374
- `backend/services/hazmat_service.py`:376
...
- `backend/services/hazmat_service.py`:341
- `backend/services/hazmat_service.py`:371
...
**Canonical Source:** `backend/services/elevation_service.py`
