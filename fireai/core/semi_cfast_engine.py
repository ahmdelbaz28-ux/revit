...
def _compute_optical_density(
    ...
    # Upper layer volume: assume smoke fills upper ~1/3 of room initially
    # (simplified; real distribution depends on layer height)
    room_volume = room_area_m2 * room_height_m
    upper_layer_volume = room_volume / 3.0  # Conservative: smaller volume = higher conc.
