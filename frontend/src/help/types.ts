...
export const HELP_TREE: HelpTreeNode[] = [
  ...
  },
  {
    ...
    labelAr: 'الهندسة',
    icon: '🧮',
    topics: ['engineering.overview', 'engineering.voltage-drop', 'engineering.cable-sizing', 'engineering.battery'],
  },
  {
    category: 'fire-alarm',
    labelEn: 'Fire Alarm',
    ...
    icon: '🔥',
    topics: ['fire-alarm.detector-placement', 'fire-alarm.symbol-library', 'fire-alarm.zone-navigation'],
  },
  {
    category: 'autocad',
    labelEn: 'AutoCAD',
  ...
  },
  {
    ...
    icon: '🔄',
    topics: ['digital-twin.overview', 'digital-twin.convert', 'digital-twin.config', 'digital-twin.history'],
  },
  {
    category: 'reports',
    labelEn: 'Reports',
  ...
  },
  {
    ...
    icon: '🔧',
    topics: ['troubleshooting.backend', 'troubleshooting.api', 'troubleshooting.auth', 'troubleshooting.app-crash'],
  },
];
