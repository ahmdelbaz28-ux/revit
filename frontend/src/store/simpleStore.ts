...
const SERIALIZABLE_KEYS: (keyof AppState)[] = [
  'theme', 'devices', 'connections', 'errorLog', 'errors',
  'selectedElementId', 'selectedElement', 'activePaletteType',
  'isSidebarOpen', 'canvasElements', 'helpOpen', 'eventLogs',
  'dataMode', 'liveData', 'connectionStatus', 'voiceActive', 'faults',
];
