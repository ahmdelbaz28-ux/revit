...
// V211: SonarCloud S2245 — use Web Crypto API (crypto.getRandomValues) instead
// of Math.random() for GUID generation. This is the RFC 4122 v4 compliant approach.
function generateGUID(): string {
        // 16 random bytes → format as xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx
