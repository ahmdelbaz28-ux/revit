	...
	return (
		...
		>
			...
			<g stroke="url(#bazBorderGrad)" strokeWidth="3" fill="none" strokeLinecap="round">
				{/* Top-Left */}
				<path d="M 38 12 H 25 A 13 13 0 0 0 12 25 V 38" />
				{/* Top-Right */}
				<path d="M 62 12 H 75 A 13 13 0 0 1 88 25 V 38" />
				{/* Bottom-Right */}
				<path d="M 88 62 V 75 A 13 13 0 0 1 75 88 H 62" />
				{/* Bottom-Left */}
				<path d="M 12 62 V 75 A 13 13 0 0 0 25 88 H 38" />
			</g>
