      ...
      return (
        <div className="flex-1 flex items-center justify-center p-8" style={{ backgroundColor: '#0f172a' }}>
          <div
            ...
            style={{ backgroundColor: 'rgba(30,41,59,0.8)', borderColor: 'rgba(153,27,27,0.5)' }}
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm mb-4" style={{ color: '#94a3b8' }}>
                  {pageLabel} encountered an error and could not render. Other pages remain functional.
                </p>
