	...
	return (
		<div className="flex flex-col h-screen w-screen overflow-hidden bg-background text-foreground dark font-sans">
					...
					<ScrollArea className="flex-1 p-4">
						<div className="space-y-0 relative before:absolute before:inset-0 before:ml-[11px] before:w-[2px] before:bg-secondary">
							<RevNode
								...
								msg="Final compliance corrections"
								current
							/>
							...
							<RevNode
								...
								user="Sarah Chen"
								msg="Updated panel LP-3A load schedule"
							/>
							<div className="h-6"></div>
							<RevNode
								rev="12"
								time="Nov 12 11:20"
								user="Ahmed"
								msg="Added circuit breaker coordination notes"
							/>
							<div className="h-6"></div>
							<RevNode
								rev="11"
								...
								msg="Approved for client review"
								approved
							/>
							<div className="h-6"></div>
							<RevNode
								...
								time="Nov 8 14:02"
								user="James Okafor"
								msg="Compliance check corrections"
							/>
							<div className="h-6"></div>
							<RevNode
								rev="9"
						...
						<table className="w-full text-left text-xs whitespace-nowrap">
							<thead className="bg-card text-muted-foreground sticky top-0 z-10 border-b border-border">
								<tr>
									...
									<th className="px-4 py-2 font-medium w-32 text-right">
										IP/Device
									</th>
								</tr>
							</thead>
							<tbody className="divide-y divide-slate-800 font-mono">
								<LogRow
									...
									type="yellow"
									msg="NEC 2023 check — 3 critical, 8 warnings"
									file="All drawings"
									dev="WS-AHM-01"
								/>
								...
								<tr className="bg-blue-500/10 border-l-2 border-l-blue-500 hover:bg-blue-500/20 cursor-pointer text-foreground">
									...
									<td
										className="px-4 py-2.5 truncate max-w-[300px]"
										title="Panel LP-3A: voltage rating changed 240V→480V"
									>
								...
								<LogRow
									...
									type="green"
									msg="Revision 14 saved: 'Final compliance...'"
									file="Electrical-Floor3.dwg"
									dev="WS-AHM-01"
								/>
								<LogRow
									time="14:31:58"
									...
									action="BIM_SYNC"
									type="slate"
									msg="BIM model synchronized with Revit v14"
									file="BIM-Model.rvt"
									dev="Server"
									isSystem
								/>
								<LogRow
									...
									type="blue"
									msg="Comment on Panel LP-3A: 'Verify load schedule'"
									file="Electrical-Floor3.dwg"
									dev="Laptop-SC-03"
								/>
								<LogRow
									...
									type="orange"
									msg="Exported compliance report to PDF (4.2MB)"
								...
								<LogRow
									...
									type="blue"
									msg="Smoke detector SD-051 added at Room 312"
									file="Fire-Alarm-Plan.dwg"
									dev="WS-FA-04"
								/>
								...
								<LogRow
									...
									action="AUTOSAVE"
									type="slate"
									msg="Auto-save complete — all 5 files"
									file="All"
									dev="Server"
									isSystem
								/>
								<LogRow
									...
									action="ANALYSIS_RUN"
									type="purple"
									msg="Arc flash study run — labels generated for 6..."
									file="All"
									dev="WS-AHM-01"
								/>
								<LogRow
									...
									type="orange"
									msg="IFC model imported (MEP-Coord-v3, 89MB)"
									file="MEP-Coordination.ifc"
									dev="WS-JO-02"
								/>
								<LogRow
									time="13:10:22"
									...
									type="slate"
									msg="Collaboration session joined (SES-2024-4821)"
									file="—"
									dev="Laptop-SC-03"
								/>
								<LogRow
									...
									action="SESSION_START"
									type="slate"
									msg="Collaboration session started (SES-2024-4821)"
									file="—"
									dev="WS-AHM-01"
								/>
							</tbody>
					...
					<ScrollArea className="flex-1">
						<div className="p-4 space-y-6">
							<div>
								...
								<h3 className="font-bold text-sm leading-tight text-white mb-4">
									Panel LP-3A Properties Updated
								</h3>
			...
			<div className="h-10 border-t bg-card flex items-center justify-between px-4 text-[11px] shrink-0 text-muted-foreground">
				...
				<div className="flex items-center gap-4">
					<span className="cursor-pointer hover:text-foreground underline">
						Configure Retention
					</span>
					<span className="cursor-pointer hover:text-foreground underline">
...
function LogRow({ time, user, action, type, msg, file, dev, isSystem }: any) {
	...
	return (
		...
		>
			...
			<td
				className={`px-4 py-2.5 truncate max-w-[300px] ${textStyle}`}
				title={msg}
			>
				{msg}
			</td>
