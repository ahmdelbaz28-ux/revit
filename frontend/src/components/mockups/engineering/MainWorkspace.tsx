        ...
        <div className="h-10 flex items-center justify-between px-4 border-b border-border/50">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 text-primary">
              ...
              <span className="font-bold tracking-wider text-sm">NexusCAD Pro</span>
            </div>
            <Separator orientation="vertical" className="h-5" />
            <div className="flex text-xs space-x-1">
              {["File", "Edit", "View", "Insert", "Annotate", "Structure", "Electrical", "BIM", "AI", "Collaborate", "Tools", "Help"].map((tab) => (
                <button
                  key={tab}
        ...
        <div className="h-14 flex items-center px-2 space-x-1 bg-card/50 overflow-x-auto">
          {activeTab === "Electrical" && (
            <>
              ...
              <RibbonBtn icon={<Zap className="text-amber-400" />} label="Arc Flash" />
              ...
              <div className="p-3">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-muted-foreground font-mono">ID: ELEC-PNL-8932</div>
                  </div>
                </div>
          ...
          <div className="flex-1 flex flex-col bg-card/20">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="bg-muted px-3 py-2 rounded-lg rounded-tl-none text-xs text-foreground border">
                      Panel LP-3A is currently loaded at 285A (71% of 400A capacity).
                      <br/><br/>
                      <span className="text-emerald-400 font-mono">Status: Safe</span>
                      <br/>
                      Remaining capacity: 115A.
                    </div>
                    <div className="flex gap-1 mt-1">
                      <Badge variant="secondary" className="text-[10px] cursor-pointer hover:bg-secondary/80">View Details</Badge>
                      <Badge variant="secondary" className="text-[10px] cursor-pointer hover:bg-secondary/80">Generate Report</Badge>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="p-2 border-t bg-card/50">
              <div className="flex gap-1 mb-2 overflow-x-auto pb-1 scrollbar-hide">
                <Badge variant="outline" className="text-[10px] whitespace-nowrap cursor-pointer">Check Compliance</Badge>
        ...
        <div className={`flex-1 overflow-hidden transition-opacity duration-200 ${isErrorLogExpanded ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
          <ScrollArea className="h-full w-full font-mono text-xs">
            <div className="flex flex-col">
              <LogEntry level="ERROR" time="14:47:03" source="NEC Compliance" message="Panel LP-3A: Neutral bar spacing violates NEC §408.36 — clearance 38mm < 50mm required" />
              <LogEntry level="ERROR" time="14:46:51" source="Load Calculator" message="MDB-B overloaded: demand 978A exceeds 800A bus rating (122.3%)" />
              <LogEntry level="ERROR" time="14:45:22" source="Arc Flash" message="Panel LP-3A: Arc flash label missing. Incident energy 52.4 cal/cm² — PPE Cat 4 required" />
...
function LogEntry({ level, time, source, message }: { level: "ERROR" | "WARN" | "INFO", time: string, source: string, message: string }) {
  ...
  return (
    <div className={`flex items-center px-4 py-1.5 border-b border-border/30 hover:bg-muted/30 group ${isError ? 'bg-red-950/20 border-l-2 border-l-red-500' : isWarn ? 'bg-orange-950/20 border-l-2 border-l-orange-500' : 'border-l-2 border-l-transparent'}`}>
      ...
      <div className="w-[130px] shrink-0 text-slate-500 truncate pr-4">{source}</div>
      ...
      <div className="shrink-0 flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity">
        {level !== "INFO" && <span className="text-blue-400 hover:underline cursor-pointer">Go To</span>}
