		...
		<div className="flex flex-col h-screen w-screen overflow-hidden bg-background text-foreground dark font-sans">
			...
			<div className="flex flex-1 overflow-hidden">
						...
						<div className="p-4 space-y-6">
								...
								<div className="space-y-3">
									...
									<div className="bg-blue-500/10 border border-blue-500/20 rounded-md p-2 space-y-1 mt-2">
										<div className="flex justify-between text-xs">
											<span className="text-info">Design Load</span>
											<span className="font-mono text-info font-bold">
												157.25 kW
											</span>
										</div>
										<div className="flex justify-between text-xs">
											<span className="text-info">Full Load Current</span>
											<span className="font-mono text-info font-bold">
												218.4 A
											</span>
										</div>
							...
							<section>
								...
								<div className="space-y-2">
									...
									<div className="flex justify-between items-center text-xs p-1.5 rounded bg-card">
				...
				<div className="flex-1 flex flex-col bg-[#0a0a0f] overflow-hidden">
					<div className="px-6 py-4 flex justify-between items-center border-b border-slate-800 bg-muted/50">
					...
					<ScrollArea className="flex-1">
						<div className="p-6 max-w-4xl mx-auto space-y-6">
							...
							<div className="bg-card border border-border rounded-lg p-5 shadow-lg relative overflow-hidden">
								<div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 blur-3xl rounded-full"></div>
								<div className="text-xs font-bold text-muted-foreground uppercase mb-2 tracking-wider">
									Recommended Cable
								</div>
								<div className="text-3xl font-bold text-info mb-1 font-mono tracking-tight">
									95mm² Cu XLPE/PVC
								</div>
								...
								<div className="grid grid-cols-2 gap-4 mt-6 border-t border-border pt-4">
									...
									<div>
										...
										<Badge className="mt-1 bg-emerald-500/20 text-success border-success/30 font-normal">
							...
							<div className="bg-muted/50 border border-border rounded-lg p-5 shadow-sm">
								...
								<div className="mb-4">
									...
									<div className="relative h-4 bg-card rounded overflow-hidden border border-border">
										<div
									...
									<div className="flex justify-between mt-1">
										...
										<span className="text-[10px] text-danger">Limit: 5%</span>
									</div>
								</div>
							...
							<div className="grid grid-cols-2 gap-6">
								...
								<div className="bg-muted/50 border border-border rounded-lg p-5 shadow-sm">
									<div className="flex justify-between items-center mb-4">
										...
										<Badge className="bg-emerald-500/20 text-success border-success/30">
											PASS
										</Badge>
									</div>
									<div className="space-y-3">
								...
								<div className="bg-muted/50 border border-border rounded-lg p-5 shadow-sm">
									...
									<div className="space-y-3">
										<div className="flex justify-between text-sm">
											<span className="text-muted-foreground">Neutral Conductor:</span>
											<span className="font-mono">50mm²</span>
										</div>
										<div className="flex justify-between text-sm">
											<span className="text-muted-foreground">Protective Earth:</span>
											<span className="font-mono">50mm²</span>
										</div>
										<div className="text-[10px] text-muted-foreground mt-1">
							...
							{/* Summary Table */}
							<div className="bg-card/30 border border-border rounded-lg overflow-hidden mt-6">
								<table className="w-full text-left text-sm">
									...
									<tbody className="divide-y divide-slate-700/50">
										<tr className="hover:bg-muted/50 transition-colors">
											<td className="px-4 py-3 text-foreground/90">Cable size</td>
										...
										<tr className="hover:bg-muted/50 transition-colors">
											<td className="px-4 py-3 text-foreground/90">Voltage drop</td>
										...
										<tr className="hover:bg-muted/50 transition-colors">
											<td className="px-4 py-3 text-foreground/90">SC withstand</td>
										...
										<tr className="hover:bg-muted/50 transition-colors">
											<td className="px-4 py-3 text-foreground/90">PE sizing</td>
							...
							{/* Accordion mockup */}
							<div className="border border-border rounded-md p-3 bg-card/20 text-sm flex justify-between items-center cursor-pointer hover:bg-card/40">
