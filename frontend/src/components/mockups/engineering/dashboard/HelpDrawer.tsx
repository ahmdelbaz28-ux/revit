...
import { Book, X, FileText, LifeBuoy } from "lucide-react";
...
export function HelpDrawer({ helpOpen, onHelpToggle }: HelpDrawerProps) {
  return (
    <div className={`absolute top-14 right-0 bottom-0 w-80 bg-card border-l border-border shadow-xl transform transition-transform duration-300 ease-in-out z-50 ${
