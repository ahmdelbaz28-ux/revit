  ...
  return (
    <div className="flex gap-4 text-xs font-mono">
      <div className="bg-background/80 px-2 py-1 rounded border border-border">
        <span className="text-muted-foreground">V:</span> <span className="text-primary font-bold">{voltage.toFixed(1)}</span>
      </div>
      <div className="bg-background/80 px-2 py-1 rounded border border-border">
        <span className="text-muted-foreground">I:</span> <span className="text-primary font-bold">{current.toFixed(2)}</span>
      </div>
      <div className="bg-background/80 px-2 py-1 rounded border border-border">
        <span className="text-muted-foreground">F:</span> <span className="text-primary font-bold">{frequency.toFixed(2)}</span>
      </div>
      {dataMode === 'live' && (
        <>
