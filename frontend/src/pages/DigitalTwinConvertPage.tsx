  ...
  return (
    <div className="flex-1 overflow-auto p-6 max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Digital Twin — Convert</h1>
          <p className="text-sm text-slate-400 mt-1">Bidirectional conversion between AutoCAD and Revit</p>
        </div>
        {status && (
