...
export function MarinePage() {
        ...
        const buildShipPayload = () => ({
                ship: {
                        ...
                        length_overall_m: Number.parseFloat(ship.length_overall_m) || 120,
                        gross_tonnage: Number.parseFloat(ship.gross_tonnage) || 50000,
                        passenger_capacity: Number.parseInt(ship.passenger_capacity) || 2000,
