...
const COPY_MAP = [
	{
		from: path.join(PROJECT_ROOT, "backend"),
		to: path.join(ROOT, "electron", "backend"),
	},
	{
		from: path.join(PROJECT_ROOT, "parsers"),
		to: path.join(ROOT, "electron", "parsers"),
	},
	{
		from: path.join(PROJECT_ROOT, "core"),
		to: path.join(ROOT, "electron", "core"),
	},
	{
		from: path.join(PROJECT_ROOT, "fireai"),
		to: path.join(ROOT, "electron", "fireai"),
	},
	{
		from: path.join(PROJECT_ROOT, "requirements.txt"),
		to: path.join(ROOT, "electron", "requirements.txt"),
	},
];
