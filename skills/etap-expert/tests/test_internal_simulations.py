...
class TestCableSizingRegression:
    ...
    def test_voltage_drop_matches_skill(self):
    ...
    def test_voltage_drop_pct_matches_skill(self):
        result = simulate_cable_sizing()
        # Skill says %VD = 1.13%
    ...
    def test_recommended_size_matches_skill(self):
        result = simulate_cable_sizing()
...
class TestTransformerSizingRegression:
    ...
    def test_required_kva_matches_skill(self):
    ...
    def test_recommended_size_is_standard(self):
    ...
    def test_loading_pct_within_reasonable_range(self):
...
class TestProtectionCoordinationRegression:
    ...
    def test_motor_fla_matches_skill(self):
    ...
    def test_relay_50_pickup_matches_skill(self):
        result = simulate_protection_coordination()
...
class TestArcFlashRegression:
    ...
    def test_arcing_current_matches_skill(self):
    ...
    def test_arcing_current_formula_correct(self):
    ...
    def test_ppe_category_in_valid_range(self):
        result = simulate_arc_flash()
        assert 0 <= result.ppe_category <= 4

    def test_ppe_category_matches_energy(self):
        ...
        for energy, expected_cat, _ in [
            ...
            cat, min_rating = determine_ppe_category(energy)
    ...
    def test_extreme_hazard_warning_for_high_energy(self):
...
class TestFLISRRegression:
    ...
    def test_fault_distance_matches_skill(self):
    ...
    def test_impedance_calculation_correct(self):
        """Z_fault = V_source / I_fault."""
        result = simulate_flisr(fault_current_a=5000.0, source_voltage_v=13800.0)
        z = 13800.0 / 5000.0
        assert abs(z - 2.76) < 0.01

    def test_isolation_time_typical(self):
        """Automated switch isolation should be ≤ 60s."""
        result = simulate_flisr()
        assert 0 < result.isolation_time_seconds <= 60

    def test_restoration_time_typical(self):
        """Automated restoration should be ≤ 5 minutes."""
        result = simulate_flisr()
        assert result.restoration_time_minutes <= 5.0

    def test_alternate_source_capacity_checked(self):
    ...
    def test_no_restoration_when_alternate_source_full(self):
