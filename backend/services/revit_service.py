...
class RevitService:
    ...
    def create_wall(
        ...
        try:
            if self._connection_method == ConnectionMethod.API and self._revit_doc:
                from Autodesk.Revit.DB import Transaction, Wall, WallType, Level, XYZ, Line
    ...
    def create_floor(
        ...
        try:
            if self._connection_method == ConnectionMethod.API and self._revit_doc:
                from Autodesk.Revit.DB import Transaction, Floor, FloorType, Level, XYZ, CurveLoop, Line
    ...
    def create_door(
        ...
        try:
            if self._connection_method == ConnectionMethod.API and self._revit_doc:
                from Autodesk.Revit.DB import Transaction, FamilySymbol, XYZ, Wall, Level
    ...
    def load_revit_api_data(self, json_path: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Loaded {len(self._api_data_cache)} API entries")
            return True
    ...
    def _get_wall_type_id(self, wall_type_name: str):
        ...
        try:
            from Autodesk.Revit.DB import WallType, FilteredElementCollector
    ...
    def _get_floor_type_id(self, floor_type_name: str):
        ...
        try:
            from Autodesk.Revit.DB import FloorType, FilteredElementCollector
