...
>>>>>>> c1d7fb42e6fb81df96dd0f01e9e06b9f73e295e1
    ...
    def create_wall(  # noqa: F811  (legacy duplicate kept for backward-compat)
        ...
        try:
            if self._connection_method == ConnectionMethod.API and self._revit_doc:
                from Autodesk.Revit.DB import Transaction, Wall, XYZ, Line
    ...
    def create_floor(  # noqa: F811  (legacy duplicate kept for backward-compat)
        ...
        try:
            if self._connection_method == ConnectionMethod.API and self._revit_doc:
                from Autodesk.Revit.DB import Transaction, Floor, XYZ, CurveLoop, Line
    ...
    def create_door(
        ...
        try:
            if self._connection_method == ConnectionMethod.API and self._revit_doc:
                from Autodesk.Revit.DB import Transaction, XYZ, Level
