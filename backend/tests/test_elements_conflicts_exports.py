...
class TestElementsFullCycle:
    ...
    def test_list_elements_with_project_filter(self, client) -> None:
    ...
    def test_delete_element_nonexistent(self, client) -> None:
...
class TestConflictsOperations:
    ...
    def test_list_conflicts(self, client) -> None:
    ...
    def test_list_conflicts_with_pagination(self, client) -> None:
        """GET /api/conflicts with pagination."""
        resp = client.get("/api/conflicts?page=1&page_size=10")
        assert resp.status_code == 200

    def test_list_conflicts_with_resolved_filter(self, client) -> None:
        """GET /api/conflicts with resolved filter."""
        resp = client.get("/api/conflicts?resolved=false")
        assert resp.status_code == 200

    def test_list_conflicts_with_type_filter(self, client) -> None:
    ...
    def test_resolve_nonexistent_conflict(self, client) -> None:
    ...
    def test_resolve_conflict_with_invalid_strategy(self, client) -> None:
    ...
    def test_resolve_conflict_last_write_wins(self, client) -> None:
...
class TestExportEndpoints:
    ...
    def test_export_dxf(self, client, project_with_device) -> None:
    ...
    def test_export_revit(self, client, project_with_device) -> None:
    ...
    def test_export_ifc_nonexistent_project(self, client) -> None:
...
class TestReportExportFormats:
    ...
    def test_export_report_json_format(self, client, project_with_device) -> None:
    ...
    def test_export_report_pdf_format(self, client, project_with_device) -> None:
