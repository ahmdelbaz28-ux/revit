...
class WSMessage:
    ...
    @classmethod
    def from_json(cls, data: str) -> Optional[WSMessage]:
...
class ConnectionManager:
    ...
    async def notify(self, room: str, message: str, level: str = "info"):
    ...
    async def notify_error(self, room: str, error: str, task_id: Optional[str] = None):
...
async def websocket_client(websocket: WebSocket, token: Optional[str] = None, 
                           room: Optional[str] = None):
    """
